...
def generate_representation(sc_model_id, timestamp, flextime=None, runset_id=None, debug_lvl=0):
    ...
    requiered_repres1 = 'preacchil03hh'
    requiered_repres2 = 'dcufldicuih'
    ...
    if the_timestamp is None:
        Debug.dl("plot_cmps_representations_lib: Not found a matching timestamp for '{0}' and '{1}' ('{2}').".format(
    ...
    ReprComposition.plot_composition_map(sc_model_id, the_timestamp, 'pa03hdflicih', requiered_repres1, requiered_repres2,
