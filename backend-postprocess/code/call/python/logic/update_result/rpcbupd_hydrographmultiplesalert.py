...
def update_display_files(modelcomb_id, runset_id, timestamp, debug_lvl=0):
    ...
    sc_reprcomp = "hydrographmultiplesalert"
...
def update_historical_representations_composition(sc_modelcomb_id, sc_reprcomp_id, sc_runset_id, ref0_timestamp,
    ...
    elif modelforestgalert_model_ids is None:
        Debug.dl("rpcbupd_hydrographmultiplesalert: Needs at least one 'modelforestgalert' model.", 0, debug_lvl)
        return
    ...
    modelforestg_model_ids = [] if modelforestg_model_ids is None else modelforestg_model_ids
    ...
    if modelforestgalert_model_ids is not None:
        ...
        min_timestamp_limit = ref0_timestamp - (3600 * 2.5)
        max_timestamp_limit = ref0_timestamp + (3600 * 2.5)
        for cur_modelforestg_model_id in modelforestgalert_model_ids:
            ...
            Debug.dl("rpcbupd_hydrographmultiplesalert: Filled '{0}' folder with {1} files.".format(
                modelforestg_dest_folder_path, num_copy), 1, debug_lvl)
