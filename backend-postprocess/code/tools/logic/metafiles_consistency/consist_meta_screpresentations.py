...
is_ok = MetaFilesConsistEvaluator.evaluate_screpresentation(runset_id=runset_id)

if output_format == 1:
    printed = "SC representation files are OK" if is_ok else "SC representation files are bad"
    print(printed)
