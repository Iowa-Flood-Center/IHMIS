class ConsoleCall:
    ...
    @staticmethod
    def get_arg_flag(arg, argv):
        """

        :param arg: A string (example: -verbose)
        ...
        if (arg is None) or (argv is None):
            return None
        return True if arg in argv else False

    @staticmethod
    def get_arg_str(arg, argv, default_value=None):
        """

        :param arg: Either a number (for index) or a string (for argument name - example: '-t')
        :param argv: Usually it is expected to be placed "sys.argv"
    ...
    @staticmethod
    def get_arg_int(arg, argv, default_value=None):
        """
        ...
        return int(arg_str) if ((arg_str is not None) and (arg_str != '')) else default_value

    @staticmethod
    def get_arg_flt(arg, argv, default_value=None):
        """
        ...
        """
        arg_str = ConsoleCall.get_arg_str(arg, argv)
        return float(arg_str) if ((arg_str is not None) and (arg_str != '')) else default_value
