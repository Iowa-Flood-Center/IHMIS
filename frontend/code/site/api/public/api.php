...
require_once '../app/dbconnection/database.php';             // database
require_once '../app/fsconnection/foldersystem.php';         // local
require_once '../app/rfsconnection/remotefoldersystem.php';  // remote
...
$app->rfs = RemoteFolderSystemFactory::create();
$app->log = (object) null;
