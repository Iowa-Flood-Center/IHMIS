...
class FolderSystemFactory{
	...
	const DEF_FILE_PATH =         "../../../../conf/site/api_3_2/fsconnection/fsdefinition.json";
	const DEF_DEPLOY_FILE_PATH =  "../../../../conf/site/api_3_2/fsconnection/fsdefinition_deploy.json";
	const DEF_SANDBOX_FILE_PATH = "../../../../conf/site/api_3_2/fsconnection/fsdefinition_sandbox.json";
