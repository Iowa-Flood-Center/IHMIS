...
GLB_vars_settings.prototype.delete_url = mpu.proxy + mpu.base_webservice + "ws_delete_runset.php";      // TODO - move to API
GLB_vars_settings.prototype.settings_base_url = mpu.base_frontend + "index/settings/";
GLB_vars_settings.prototype.evaluations_list_url = mpu.proxy + GLB_vars_settings.prototype.settings_base_url + "ws_list_evaluations_possible.php";
GLB_vars_settings.prototype.evaluations_delete_url = mpu.proxy + GLB_vars_settings.prototype.settings_base_url + "ws_delete_evaluation_possible.php";
