<?php
  ...
  $sc_ref0_file_path = "txts_timestamp_ref0/".$sc_reference_id."/".$sc_representation_id.".txt";
  $json_folder = "repres_displayed/".$sc_reference_id."/".$sc_representation_id."/";
   ...
   * RETURN : A positive integer if a previous value is expected to be available, '-1' otherwise.
   */
  function setup_prev_h_timestamp($ref0_timestamp, $effc_timestamp, $json_folder, $json_format, $runset_id){
  ...
  $json_content = read_file($sc_reftime, $json_folder, $json_format, 
                            $sc_runset_id);
