<?php
  ...
  $sc_represcomb_id = "hydrographmultiplesalertpast";
  ...
  $modelpaststgalert_folder_path = $root_folder_url."modelpaststgalert/";
  ...
  // find respective past files
  $all_scmodel_folders = DataAccess::list_datafolder_content($modelpaststgalert_folder_path, 
                                                             $sc_runset_id,
                                                             "\/");
  foreach($all_scmodel_folders as $cur_scmodel_folder){
    // ignore back folders references
    ...
    $cur_subfolder_path = $modelpaststgalert_folder_path.$cur_scmodel_folder."/";
    $all_inner_files = DataAccess::list_datafolder_content($cur_subfolder_path, 
                                                           $sc_runset_id,
                                                           ".json");
    foreach($all_inner_files as $cur_inner_file){
