function custom_display(opt_timestamp){
	...
	function display_when_possible(){
		...
		var cur_date = new Date(GLB_vars.prototype.disclausgssih * 1000);
		...
		nbsps = "&nbsp;&nbsp;&nbsp;";
		var gobad_html = define_gobad_html(second_legend_style_css_a, second_legend_style_css_noa);  // go-back-arrow
		var gobah_html = define_gobah_html(second_legend_style_css_a, second_legend_style_css_noa);  // go-back-arrow
		var gofah_html = define_gofah_html(second_legend_style_css_a, second_legend_style_css_noa);  // go-forward-arrow-hourly
		var gofad_html = define_gofad_html(second_legend_style_css_a, second_legend_style_css_noa);  // go-forward-arrow-daily
		date_html = gobad_html + nbsps + gobah_html + nbsps;
		date_html += "At " + cur_datetime_str + ".";
		date_html += nbsps + gofah_html + nbsps + gofad_html;
