function custom_display(){
	...
	reprcomp_id = "hydrographmultiplesalertcurrent";
	all_links_dict = null;
	...
	function display_when_possible(){
		var cur_icon_address, chart_lib_url, cur_linkid;
	...
	function on_icon_click() {
		...
		var json_reader_ws = modelplus.viewer.ws + "custom_ws/"+reprcomp_id+"_readjson.php%i%sc_runset_id="+runset_id+"%e%sc_model_id="+model_id+"%e%link_id="+link_id;
			...
			function (ec) {
				...
				$.ajax({
					...
					if (max_past_timestamp != null){
						var current_date_data = [[max_past_timestamp, max_y_label],
...
function custom_search(search_txt){
  ...
  var reprcomp_id = "hydrographmultiplesalertpast";
