function custom_display(){
	...
	reprcomp_id = "hydrographmultiplesdotraw";
	all_links_dict = null;
	...
	$.ajax({
		...
		if (all_links_dict == null){ console.log("hydrographmultiplesdotraw: got null for all links."); }
	...
	$.ajax({
		...
		if (all_links_dict == null){ console.log("hydrographmultiplesdotraw: got null for gages location."); }
		display_when_possible();
	});
